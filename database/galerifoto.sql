...
-- 
-- Struktur tabel `komentar_foto`
-- 
CREATE TABLE `komentar_foto`(
  `komentarID` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `image_id` int(11) NOT NULL,
  `admin_id` int(11) NOT NULL,
  `admin_name` varchar(50),
  `isi_komentar` text,
...
ALTER TABLE `komentar_foto`
  ADD CONSTRAINT `tb_komentar_ibfk1` FOREIGN KEY (`image_id`) REFERENCES `tb_image` (`image_id`),
  ADD CONSTRAINT `tb_komentar_ibfk2` FOREIGN KEY (`admin_id`) REFERENCES `tb_admin` (`admin_id`);
COMMIT;
